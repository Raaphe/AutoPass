...
/**
* LandingPageMobile - 2024-04-02
* Raaphe
*
* AutoPass
*/
const LandingPageMobile: FC<LandingPageMobileProps> = () => {
        ...
        <div className="container-fluid ">
            <div className="row justify-content-center align-items-center vh-100 d-flex">
                <div className="col-md-6 text-center">
                    <img style={{transform:"scale(3)", marginBottom:"22%", marginLeft:"-2%"}} src="https://photosforraph.s3.us-east-2.amazonaws.com/output-onlinepngtools+(1).png" alt="Logo" />
