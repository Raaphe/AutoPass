...
const AboutMobile: FC<AboutMobileProps> = () => {
  ...
  return (
    <Card className="container-fluid m-2 p-3 d-grow" elevation={15} sx={{ minWidth: "70%", minHeight: "60vh" }}  >
      ...
      <Card elevation={10} className="row m-1">
        <img src={team} className="col-12" style={{  marginBottom: "45px", minWidth: "40%", minHeight: "250px" }} alt="" />
      ...
      <Card elevation={10} className="row m-1 mt-3">
        <img src={raph} className="col-12" style={{  marginBottom: "45px", minWidth: "40%", minHeight: "250px" }} alt="" />
      ...
      <Card elevation={10} className="row m-1 mt-3">
        <img src={lam} className="col-12" style={{  marginBottom: "45px", minWidth: "40%", minHeight: "240px" }} alt="" />
        <div className="col-12">
