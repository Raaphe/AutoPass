...
import { Button, Card, Container, Divider, IconButton, Typography } from "@mui/material";
...
const DashboardMobile: FC<DashboardMobileProps> = () => {
  ...
  return (
    <Card elevation={14} className="container-fluid mt-5" >
      <motion.div
        className="row "
      ...
      >
        {/* Welcome Card */}
        <div className="col-sm-4 d-flex mb-2 mt-4 justify-content-center align-items-center" >
      ...
      >
        ...
        {/* Products button */}
        <div className="col-sm-4 mb-4 mt-2 d-flex justify-content-center align-items-center">
          <Card className="card p-3 h-100" style={{ width: "100%" }} elevation={15}>
