        ...
        <div id={id} className="card mb-3">
            <div className="card-body p-0">
                <div className="row m-0">
                    <div className="col-md-6 p-0" style={{ backgroundColor: '#2175fc', color: 'white', borderTopLeftRadius: '10px', borderBottomLeftRadius: '10px', borderRight: '4px solid lightblue' }}>
                        <div className="p-3">
